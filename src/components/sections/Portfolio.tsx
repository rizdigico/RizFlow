...
export function Portfolio() {
  return (
    <section className="py-32 relative bg-black border-b border-white/5" id="work">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-16 md:flex md:items-end md:justify-between">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">Featured Work</h2>
            <p className="text-lg text-gray-400">
              We turn complex problems into elegant solutions. Here's a selection of our latest projects.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0 }}
