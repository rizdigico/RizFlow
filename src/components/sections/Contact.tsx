        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8">
          ...
          >
            ...
            <p className="text-lg text-gray-400 mb-12 max-w-lg">
              Ready to elevate your digital presence? We're here to turn your
              vision into reality. Reach out to start the conversation.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-sm text-gray-500 tracking-wider uppercase mb-1">
                    Email Us
                  </p>
                  <p className="text-xl font-medium text-white hover:text-indigo-400 transition-colors cursor-pointer">
                    hello@rizflow.com
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <form className="space-y-6">
              ...
              >
                ...
                <svg
                  className="w-5 h-5 transform rotate-45 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
