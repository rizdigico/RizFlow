...
export function FounderProfile({ compact = false }: FounderProfileProps) {
  return (
    <div className={cn('flex flex-col lg:flex-row items-center justify-between', compact ? 'gap-6' : 'gap-20 lg:gap-24')}>
      {/* Avatar with scanning ring/glow */}
      ...
      <div className="flex-1 text-center lg:text-left w-full">
        ...
        <div className="space-y-5 text-slate-300 leading-[1.8] tracking-wide text-[15px] md:text-base w-full mb-8">
          <p>
            A 17‑year‑old Nanyang Polytechnic Business Management student who has spent over 2 years working, experimenting, learning & building with AI.
          </p>
          <p>
            That lived experience inspired me to build RizFlow, an Agentic-AI powered operations partner that deploys specialized agents to handle the mundane, rule‑based work so agency founders can reclaim their focus, scale their services, and avoid burnout—all while I continue my studies and build the business side‑by‑side with my learning.
          </p>
        </div>
        ...
        {!compact && (
          <blockquote className="bg-[#050A14]/80 backdrop-blur-sm border-l-2 border-teal-500/50 p-5 text-slate-400 text-[15px] md:text-base leading-[1.8] tracking-wide w-full mb-10 relative group shadow-[0_0_20px_rgba(0,229,255,0.03)]">
            ...
            <span className="font-mono text-teal-500/50 text-xl absolute -top-4 -left-2 bg-[#0A0F1A] px-1">"</span>
        ...
        <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
          ...
          >
            <Button variant="outline" size="sm" className="font-mono uppercase tracking-widest border-teal-500/30 hover:bg-teal-500/10 hover:text-teal-400 hover:border-teal-400 transition-all shadow-[0_0_10px_rgba(0,229,255,0.05)]">
          ...
          <Link to="/audit">
            <Button variant="cta" size="sm" className="font-mono uppercase tracking-widest flex items-center gap-2">
