...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-teal text-white hover:bg-teal-dark shadow-soft hover:shadow-glow active:scale-[0.98]',
      secondary: 'bg-navy text-white hover:bg-navy-light shadow-soft active:scale-[0.98]',
      outline: 'border-2 border-teal text-teal hover:bg-teal hover:text-white active:scale-[0.98]',
