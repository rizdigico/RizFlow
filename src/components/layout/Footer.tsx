          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2">
              <Link to="/" className="flex items-center gap-3 mb-4 group w-fit">
                ...
                <span className="font-bold text-white tracking-wide text-2xl group-hover:text-cyan-light transition-colors">RizFlow</span>
              </Link>
              <p className="text-slate-300 text-sm leading-relaxed max-w-xs mb-6">
                Agentic-AI powered operations that give agency founders back 15-25 hours every week. Based in
