  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="contact RizFlow, custom AI consultation, business automation strategy call"
        />
        ...
        <meta
          ...
          content="Ready to automate your business? Get in touch with RizFlow."
        />
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-3 text-slate-400 font-mono text-sm">
                  <p>
                    {">"} Questions about RizFlow? Want to explore if we're the
                    right fit?
                  </p>
              ...
              <div className="space-y-4 bg-[#0A0F1A]/80 backdrop-blur-md border border-white/5 p-6 rounded-xl">
                ...
                <div className="flex items-center gap-4 text-slate-300">
                  ...
                  <div>
                    <p className="text-[10px] text-teal-500 font-mono uppercase tracking-widest mb-0.5">
                      Email Protocol
                    </p>
            ...
            <div className="bg-[#0A0F1A]/95 backdrop-blur-3xl border border-teal-500/30 rounded-2xl p-5 sm:p-8 shadow-[0_0_30px_rgba(0,229,255,0.1)] relative">
              ...
              {submitted ? (
                <div className="text-center py-10 border border-teal-500/20 bg-[#050A14] rounded-lg">
                  ...
                  <h3 className="text-xl font-bold font-mono text-white mb-2 uppercase tracking-wide">
                    Request Transmitted
                  </h3>
                  <p className="text-teal-400/80 font-mono text-sm">
                    Awaiting system response (ETA 24h).
                  </p>
                </div>
              ) : (
                <form
