...
const process = [
  ...
  { step: '02', title: 'PROPOSAL COMPILATION', desc: 'Custom implementation plan with clear scope, timeline, and expected ROI — delivered within 2-4 weeks.', status: 'AWAITING AUTH' },
