    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-slate-700/50 bg-[#0A0F1A]">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-teal-500 to-cyan-400 flex items-center justify-center shadow-[0_0_10px_rgba(45,212,191,0.4)]">
            <span className="text-[10px] font-bold text-white">RF</span>
          </div>
          <div>
            <p className="text-xs font-semibold text-white">rizflow-agent</p>
