  ...
  sections: [
    {
      ...
      content: 'RizFlow ("we", "our", "us") respects your privacy and is committed to protecting personal data collected through our website (rizflow.co) and our service offerings. This Privacy Policy explains what information we collect, how we use it, and your rights regarding that data.',
    },
    {
      id: 'collect',
      ...
      content: [
        ...
        '• Service data (clients only): Details of your agency\'s workflow, tool integrations, performance metrics — provided during onboarding',
        '',
    ...
    },
    {
      ...
      content: 'If you are located outside Singapore, your data may be transferred to and processed in countries where our service providers operate (e.g., United States, European Economic Area). We ensure such transfers are safeguarded by Standard Contractual Clauses (SCCs) or equivalent mechanisms.',
    },
    {
      id: 'changes',
      title: '1.10 Changes to This Policy',
      content: 'We may update this Privacy Policy from time to time. The "Last updated" date at the top reflects the most recent revision. We will notify you of material changes via email or a notice on the website.',
    },
    {
      id: 'contact-privacy',
  ...
  sections: [
    {
      ...
      content: 'By accessing or using the website rizflow.co ("Site") and/or engaging our services ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, please do not use the Site or Service.',
    },
    {
      id: 'overview',
      title: '2.2 Service Overview',
      content: [
        'RizFlow provides AI-powered agency operations consulting (the "Service") to service-based agencies (marketing, design, development, consulting, PR). The Service includes:',
        '• Free Operational Audit (no-obligation assessment)',
        '• Paid service tiers (Starter, Professional, Enterprise) that deploy specialized AI agents',
    ...
    },
    {
      ...
      content: 'You must be at least 18 years old and have the authority to bind the agency (or be acting on behalf of the agency) to enter into these Terms. The Service is intended for business-to-business (B2B) use only.',
    },
    {
      id: 'account',
      title: '2.4 Account & Registration',
      content: 'To receive the Free Operational Audit or engage a paid tier, you will need to provide accurate and complete information (name, email, phone, agency details, website). You are responsible for maintaining the confidentiality of your account credentials and for all activities under your account.',
    },
    {
      id: 'payment',
    ...
    },
    {
      ...
      content: [
        ...
        '• Your IP: You retain all rights to your data, branding, content, and any proprietary agency information you provide',
    ...
    },
    {
      ...
      content: 'THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE." WE MAKE NO WARRANTIES, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, OR THAT THE SERVICE WILL BE UNINTERRUPTED OR ERROR-FREE.',
    },
    {
      id: 'liability',
      title: '2.10 Limitation of Liability',
      content: 'TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL RIZFLOW, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, DATA, OR GOODWILL. OUR TOTAL LIABILITY FOR ANY CLAIM SHALL NOT EXCEED THE AMOUNT YOU HAVE PAID US FOR THE SERVICE IN THE PRECEDING 12 MONTHS.',
    },
    {
      id: 'indemnification',
    ...
    },
    {
      ...
      content: 'These Terms shall be governed by and construed in accordance with the laws of the Republic of Singapore, without regard to its conflict of law principles. Any dispute arising out of or relating to these Terms shall be resolved exclusively by the Singapore Courts.',
    },
    {
      id: 'misc',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="RizFlow's Privacy Policy and Terms of Service. Learn how we protect your data and the terms of our AI operations service."
        />
          ...
          <div className="max-w-4xl mx-auto bg-[#050A14] border border-white/5 shadow-[0_0_30px_rgba(0,229,255,0.05)] rounded-lg overflow-hidden relative">
            ...
            <div className="bg-[#0A0F1A] border-b border-white/5 px-4 py-2 flex items-center gap-2">
              ...
              <span className="ml-2 font-mono text-xs text-slate-500 uppercase tracking-wider">
                root@rizflow:~/{activeTab === 'privacy' ? 'privacy_policy.txt' : 'terms_of_service.txt'}
              </span>
            </div>
